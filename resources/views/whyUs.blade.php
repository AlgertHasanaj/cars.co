...
<body>
    ...
    <!-- fund navbar -->
    <!-- why us -->
    <div class="container-fluid mx-auto my-5" id="whyuscard">
        <h2 class="text-center" id="h2aboutus">About Us</h2>
        <div class="card text-bg-dark">
            <img src="{{ asset('images/bmwR.jpg') }}" class="card-img" alt="...">
            <div class="card-img-overlay" id="imgovertext">
                <p class="card-title text-center mt-5">Why us?</p>
    ...
    <section class="container-fluid my-5">
        <h3 class="text-center"><b>Pasioni per makinat</b></h3>
        <h4><b>Si nisi?</b></h4>

        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut hic, et vero quas illo culpa at, eos maxime repellat minima tempora praesentium, nostrum rerum id porro excepturi sed molestiae a.</p>
        <h4><b>Sa te besueshem jemi?</b></h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum aliquam ad praesentium sunt magnam minima dicta quibusdam illo officiis, ratione necessitatibus recusandae at, animi, doloremque possimus iure totam rem voluptas.</p>
